...
def render_query_interface(vector_store, llm_service):
    ...
    query = st.text_area(
        ...
        placeholder="e.g., 'What are the main topics discussed in the documents?' or 'Find technical specifications for the project'"
    )
    ...
    if st.button("Search", type="primary", disabled=not query):
        ...
        with st.spinner("Analyzing query and searching documents..."):
            try:
                ...
                vector_results = vector_store.query_documents(
